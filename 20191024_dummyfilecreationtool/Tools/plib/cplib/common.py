...
def makedir(dir_paths):
    """This sub-function is used to create a list of folder in give path if has
    any foler that is not existed"""
...
def getfilelist(dir_path, file_name_extension):
    """This sub-function is used to get the list of files from given
